...
const SELECT_PROFILE = `
  SELECT
    ...
    p.icon_reviewed_by,
    p.icon_reviewed_at,
    p.icon_rejected_reason,
    p.icon_bw_cid,
    p.icon_bw_mime,
    p.icon_bw_status,
    p.icon_bw_reviewed_by,
    p.icon_bw_reviewed_at,
    p.icon_bw_rejected_reason,
    p.icon_access_status,
    p.icon_access_email,
    p.icon_access_requested_at,
    p.icon_access_reviewed_at,
    p.icon_access_reviewed_by,
    p.icon_access_denied_reason,
    p.takedown_status,
    p.takedown_reason,
    p.takedown_by,
    p.takedown_at,
