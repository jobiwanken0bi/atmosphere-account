...
function GlassCloud({
  ...
  /* Extra padding: backdrop blur + feGaussianBlur (stdDev 20) + stroke 4 need room past viewBox */
    ...
    >
      ...
      >
        <div
          ...
          style={`backdrop-filter:blur(${blurRadius}px);-webkit-backdrop-filter:blur(${blurRadius}px);clip-path:url(#bgblur_${id});height:100%;width:100%`}
        />
      </foreignObject>
      ...
      <defs>
        ...
        >
          ...
          <stop offset="1" stop-color="var(--cloud-stroke-bot, #E9FEFF)" stop-opacity="0" />
        </linearGradient>
      </defs>
    </svg>
  );
...
const clouds: CloudProps[] = [
  ...
  },
  {
    ...
    width: 420,
    height: 260,
    path: "M332 259.96C332.83 259.98 333.67 260 334.51 260C381.94 260 420 225.02 420 182.81C420 141.85 384.81 107.68 339.37 105.56C327.68 74.84 295.58 53 257.93 53C252.42 53 247.03 53.48 241.81 54.39C229.15 25.49 198.16 5 161.92 5C114.42 5 75.94 39.98 75.94 82.19C75.94 89.92 77.17 97.37 79.47 104.43C35.01 107.48 0 141.25 0 182.81C0 225.02 38.47 260 85.93 260C87.33 260 88.72 259.97 90.1 259.91V260H332V259.96Z",
    fillOpacity: 0.15,
    blurRadius: 22,
    flipX: true,
    parallaxSpeed: -0.07,
