...
export default function BlueskySection() {
  ...
  const blueskyLink = (
    <a
      ...
      aria-label={t.providers.apps.blueskyAriaLabel}
    >
      <svg
    ...
    <section class="section reveal">
      <div class="container">
        <div class="text-center">
          <h2 class="text-section">{t.providers.heading}</h2>
          <div class="divider" />
          <p
        ...
        <div class="provider-grid">
          <div class="glass provider-card">
            <div class="provider-card-badge font-mono">
              {t.providers.apps.badge}
            </div>
            <div class="provider-logo-row">
              ...
              <span class="provider-name font-mono">
                {t.providers.apps.name}
              </span>
            </div>
            <p class="text-body-sm">{t.providers.apps.body(blueskyLink)}</p>
          </div>
          ...
          <div class="glass provider-card">
            <div class="provider-logo-row">
              ...
              <span class="provider-name font-mono">
                {t.providers.independent.name}
              </span>
            </div>
            <p class="text-body-sm">{t.providers.independent.body}</p>
          </div>
          ...
          <div class="glass provider-card">
            <div class="provider-logo-row">
              ...
              <span class="provider-name font-mono">
                {t.providers.selfHost.name}
              </span>
            </div>
            <p class="text-body-sm">{t.providers.selfHost.body}</p>
          </div>
        </div>
