      ...
      <div class="container">
        <div class="text-center">
          ...
          <p class="text-body mt-2" style={{ maxWidth: "640px", margin: "1rem auto 0" }}>
            Your Atmosphere account lives with a <strong>provider</strong> — a service
            that stores your data and keeps it available across every app. That
            provider might be an app you already use, or a host that only holds
            accounts. You pick who hosts your account, and you can switch any time.
          </p>
        </div>
        ...
        <div class="provider-grid">
          <div class="glass provider-card provider-card-featured">
            ...
            <p class="text-body-sm">
              ...
              are also account providers. When you sign up, they provide an account for
              you and your data is hosted by them. Some apps are not account providers:
              they are just apps, and you sign in with an account hosted somewhere
              else. If you already use Bluesky, you have an Atmosphere-ready account
              with no extra sign-up.
            </p>
          </div>
          ...
          <div class="glass provider-card">
            ...
            <p class="text-body-sm">
              Independent providers are account hosts — they are not apps themselves,
              they only hold your account and data. A growing number of them offer
              Atmosphere accounts: some are community-run, some focus on privacy, and
              new ones are launching all the time.
            </p>
          </div>
        ...
        >
          No matter which provider you choose, your account works everywhere and you can
          move to a different provider at any time — no data lost.
        </p>
      </div>
    </section>
  );
