...
const en = {
  ...
  hostsDirectory: {
    ...
    appIndicator: "App",
    appsIndicator: "apps",
    appIndicatorLabel: "Also listed as an app",
    operatesApp: (name: string) => `Also operates the ${name} app`,
    operatesApps: (count: number) => `Also operates ${count} apps`,
    hostDomain: "Host domain",
    availabilityLabel: "Host availability",
    ...
    claimDetectedHost: "Claim a detected PDS",
  },
