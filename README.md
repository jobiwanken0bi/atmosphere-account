...
`smoke:picker-assets` is a production-facing check for the hosted picker on
`login.atmosphereaccount.com`: it verifies the picker HTML, CSS, static scripts,
generated Fresh assets, and imported chunks from both the login and main
Atmosphere domains.
