...
- Cheap readiness: `deno task smoke:readiness` makes one readiness request and
  ...
  inventory, and present, matching Deno/Railway Git SHAs. GitHub runs this
  hourly and allows up to 15 minutes for both providers to converge after
  successful `main` CI; the full suite runs after deploys and once daily.
